...
void ctrlCallback(const ros::TimerEvent &event) {
  ...
  // some goals are impossible for ackermann steering to immediately steer to, hence robot might deviate some distance from the reference path -> LQR doesnt have constraints
